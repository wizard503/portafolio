...
function NavMobile({navMobile}) {
	return (
		<nav className={`${navMobile ? 'min-h-[20em]' : 'min-h-0'} lg:hidden w-full bg-neutral-600 fixed top-0 left-0 right-0 -bottom-12 -z-10 overflow-hidden transition-all h-0`}>
